...
ActiveRecord::Schema.define(version: 2020_09_12_014300) do
  ...
  create_table "transaction_statuses", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
